...
import JiraCard from "../components/jira-card";
  ...
  return (
    <div className="flex bg-white w-fit h-[103.19rem] overflow-hidden text-left text-[1rem] text-heading font-poppins">
      ...
      <Menu
        ...
        vector5="/vector5.svg"
        vector6="/vector6.svg"
        group43="/group-43.svg"
        vector7="/vector7.svg"
        group44="/group-44.svg"
        union1="/union1.svg"
        vector8="/vector8.svg"
        group="/group1.svg"
        vector9="/vector9.svg"
        ...
        menuTop="0rem"
        menuLeft="0rem"
        rectangleDivTop="56.19rem"
        rectangleDivLeft="0rem"
        rectangleDivWidth="17.5rem"
        rectangleDivHeight="5rem"
        charliewebexcomFontSize="0.75rem"
        charliewebexcomLineHeight="1.88rem"
        webexStarshipFontSize="1rem"
        webexStarshipLineHeight="1.88rem"
        logoIconObjectFit="cover"
        insightsFontSize="1rem"
        applicationsFontSize="1rem"
        transactionsFontSize="1rem"
        renewalsFontSize="1rem"
        employeesFontSize="1rem"
        groupDivOpacity="unset"
        integrationsFontSize="1rem"
        integrationsColor="#8b3dff"
        accountFontSize="1rem"
        mENUTop="11.56rem"
        mENULeft="2.13rem"
        mENUFontSize="0.81rem"
        sETTINGSTop="30.94rem"
        sETTINGSLeft="2.13rem"
        sETTINGSFontSize="0.81rem"
        lineDivTop="-0.03rem"
        lineDivLeft="17.47rem"
        lineDivWidth="0.06rem"
        lineDivHeight="65.63rem"
        ellipseDivTop="15.38rem"
        ellipseDivLeft="15.81rem"
      ...
      <Header
        ...
        headerWidth="102.5rem"
        headerHeight="4.44rem"
        headerPosition="absolute"
        headerTop="0rem"
        headerLeft="17.56rem"
        searchByEmployeeFontSize="1rem"
        frameDivPadding="0.5rem 1.25rem"
        frameDivGap="0.63rem"
        groupIconWidth="1.38rem"
        groupIconHeight="1rem"
        inviteMembersFontSize="1rem"
        questionIcon4Top="1.44rem"
        questionIcon4Left="1.69rem"
      ...
      <Group
        groupGroup55="/group-66.svg"
        groupIconWidth="8rem"
        groupIconHeight="9.5rem"
      ...
      <div className="absolute top-[34.19rem] left-[31.25rem] text-[1.25rem] font-medium">
        Accounting
      </div>
      <div className="absolute top-[61.94rem] left-[31.25rem] text-[1.25rem] font-medium">
        Engagement
      </div>
      ...
      <div className="absolute top-[46.44rem] left-[36.69rem] text-[1.13rem] font-medium">
        Quickbooks
      </div>
      ...
      <div className="absolute top-[28.06rem] left-[36.69rem] text-b778c"  style={{ whiteSpace: 'nowrap' }}>
        Setup Office 365 if your organization depends on it as an Identity
        provider
      </div>
      <div className="absolute top-[40.63rem] left-[36.69rem] text-b778c"  style={{ whiteSpace: 'nowrap' }}>
        Gather actionable information for every known Application that persists
        in your books
      </div>
      <div className="absolute top-[48.19rem] left-[36.69rem] text-b778c"  style={{ whiteSpace: 'nowrap' }}>
        Organize your App spend and gather actionable insights to make informed
        decisions
      </div>
      <div className="absolute top-[55.75rem] left-[36.69rem] text-b778c"  style={{ whiteSpace: 'nowrap' }}>
        Manually upload your transaction data every month and stay aware of your
        App spend and usage
      </div>
      <div className="absolute top-[19.13rem] left-[97.75rem] w-[6.69rem] h-[2.5rem] text-white">
        <div className="absolute top-[0rem] left-[0rem] rounded-8xs bg-primery w-[6.69rem] h-[2.5rem]" />
        <div className="absolute top-[0.5rem] left-[1.19rem]">Connect</div>
      </div>
      <div className="absolute top-[26.69rem] left-[97.75rem] w-[6.69rem] h-[2.5rem] text-white">
        <div className="absolute top-[0rem] left-[0rem] rounded-8xs bg-primery w-[6.69rem] h-[2.5rem]" />
        <div className="absolute top-[0.5rem] left-[1.19rem]">Connect</div>
      </div>
      <div className="absolute top-[39.25rem] left-[97.75rem] w-[6.69rem] h-[2.5rem] text-white">
        <div className="absolute top-[0rem] left-[0rem] rounded-8xs bg-primery w-[6.69rem] h-[2.5rem]" />
        <div className="absolute top-[0.5rem] left-[1.19rem]">Connect</div>
      </div>
      <div className="absolute top-[46.81rem] left-[97.75rem] w-[6.69rem] h-[2.5rem] text-white">
        <div className="absolute top-[0rem] left-[0rem] rounded-8xs bg-primery w-[6.69rem] h-[2.5rem]" />
        <div className="absolute top-[0.5rem] left-[1.19rem]">Connect</div>
      </div>
      <div className="absolute top-[54.38rem] left-[97.75rem] w-[6.69rem] h-[2.5rem] text-white">
        <div className="absolute top-[0rem] left-[0rem] rounded-8xs bg-primery w-[6.69rem] h-[2.5rem]" />
      ...
      />
      <img
        className="absolute top-[19.31rem] left-[33.06rem] w-[2.13rem] h-[2.13rem] object-cover"
        alt=""
        src="/image-36@2x.png"
      />
      <img
      ...
      <div className="absolute top-[38.88rem] left-[32.5rem] w-[3.25rem] h-[3.25rem]">
        ...
        <img
          className="absolute top-[1.25rem] left-[0.31rem] w-[2.75rem] h-[0.81rem] object-cover"
          alt=""
          src="/image-31@2x.png"
        />
      </div>
      <div className="absolute top-[46.44rem] left-[32.5rem] w-[3.25rem] h-[3.25rem]">
        <div className="absolute top-[0rem] left-[0rem] rounded-3xs bg-green w-[3.25rem] h-[3.25rem]" />
        <img
          className="absolute top-[0.69rem] left-[0.44rem] w-[2.31rem] h-[1.94rem] object-cover"
          alt=""
          src="/image-32@2x.png"
        />
      </div>
      <div className="absolute top-[54rem] left-[32.5rem] w-[3.25rem] h-[3.25rem]">
        <div className="absolute top-[0rem] left-[0rem] rounded-3xs bg-azure w-[3.25rem] h-[3.25rem]" />
        <img
          className="absolute top-[0.56rem] left-[0.81rem] w-[1.63rem] h-[2.19rem] object-cover"
          alt=""
      ...
      />
      <img
        className="absolute h-[0.85%] w-[0.63%] top-[38.1%] right-[64.27%] bottom-[61.05%] left-[35.1%] max-w-full overflow-hidden max-h-full"
        alt=""
        src="/vector11.svg"
      />
      ...
      />
      <img
        className="absolute h-[0.85%] w-[0.63%] top-[52.76%] right-[64.43%] bottom-[46.4%] left-[34.95%] max-w-full overflow-hidden max-h-full"
        alt=""
        src="/vector15.svg"
      />
      <div className="absolute top-[65.06rem] left-[31.25rem] w-[75.06rem] h-[6.31rem] opacity-[0.5] text-[1.13rem]">
        <div className="absolute top-[0rem] left-[0rem] w-[75.06rem] h-[6.31rem]">
          {/* <div className="absolute top-[0rem] left-[75.06rem] rounded-3xl [background:linear-gradient(90.11deg,_rgba(255,_255,_255,_0),_rgba(239,_239,_239,_0.5))] box-border w-[75.06rem] h-[6.31rem] [transform:_rotate(180deg)] [transform-origin:0_0]" /> */}
        </div>
        <div className="absolute top-[1.56rem] left-[5.44rem] font-medium">
          Zoom
        </div>
        <div className="absolute top-[3.31rem] left-[5.44rem] text-[1rem] text-b778c">
          Gather actionable insights off Zoom and stay aware of its user
          engagement and analyse spend
        </div>
        <div className="absolute top-[1.56rem] left-[1.25rem] w-[3.25rem] h-[3.25rem]">
          <div className="absolute top-[0rem] left-[0rem] rounded-3xs bg-dodgerblue w-[3.25rem] h-[3.25rem]" />
          <img
            className="absolute top-[1rem] left-[0.5rem] w-[2.25rem] h-[1.31rem] object-cover"
            alt=""
            src="/image-33@2x.png"
          />
        </div>
      ...
      <div className="absolute top-[72.63rem] left-[31.25rem] w-[75.06rem] h-[6.31rem] opacity-[0.5] text-[1.13rem]">
        ...
        <div className="absolute top-[1.56rem] left-[1.25rem] w-[3.25rem] h-[3.25rem]">
          <div className="absolute top-[0rem] left-[0rem] rounded-3xs bg-darkslateblue w-[3.25rem] h-[3.25rem]" />
        </div>
        <img
          className="absolute top-[1.75rem] left-[1.44rem] w-[2.88rem] h-[2.88rem] object-cover"
          alt=""
          src="/image-37@2x.png"
        />
      </div>
